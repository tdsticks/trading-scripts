...
split_the_difference = 0 #Detects bases at 50% of wicks rather than the low or close prices. Setting this to 1 will cause the low_or_close variable to be ignored
